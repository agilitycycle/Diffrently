...
const CardSmaller = (props) => {
  ...
  return (<div className="relative mb-7 mx-auto bg-transparent border border-gray-200 rounded-lg shadow dark:bg-transparent dark:border-gray-700">
     ...
     */}
    {openMenu && (
      <a href={null} onClick={toggleSubmenu} className="cursor-pointerx z-20 absolute right-0 w-full h-full">
    ...
    <div className={`${openMenu ? 'flex' : 'hidden'} items-center justify-center absolute top-[65px] right-[28px] z-30 w-[120px]`}>
