                    ...
                    <div className="flex flex-col items-start justify-start">
                      <div className="inline-flex justify-start gap-3">
                        <div className="min-w-[20px] mb-1">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="stroke-white mt-0.5">
                            <path
                        ...
                        <p className="text-base text-gray-400">25 tags / 5 images</p>
                      </div>
                      <div className="inline-flex justify-start gap-3">
                        <div className="min-w-[20px] mb-1">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="stroke-white mt-0.5">
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col items-start justify-start">
                      <div className="inline-flex justify-start gap-3">
                        ...
                        <p className="text-base text-gray-400">250 tags / 25 images</p>
                      </div>
                      <div className="inline-flex justify-start gap-3">
                        <div className="min-w-[20px] mb-1">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="stroke-white mt-0.5">
                      ...
                      <div className="inline-flex justify-start gap-3">
                        ...
                        <p className="text-base text-gray-400">Functions</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col items-start justify-start">
                      <div className="inline-flex justify-start gap-3">
                        ...
                        <p className="text-base text-gray-400">5 generated images</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col items-start justify-start">
                      <div className="inline-flex justify-start gap-3">
                        ...
                        <p className="text-base text-gray-400">25 tags / 25 images</p>
                      </div>
                      <div className="inline-flex justify-start gap-3">
                        <div className="min-w-[20px] mb-1">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="stroke-white mt-0.5">
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col items-start justify-start">
                      <div className="inline-flex justify-start gap-3">
                        ...
                        <p className="text-base text-gray-400">500 tags / 50 images</p>
                      </div>
                      <div className="inline-flex justify-start gap-3">
                        <div className="min-w-[20px] mb-1">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="stroke-white mt-0.5">
