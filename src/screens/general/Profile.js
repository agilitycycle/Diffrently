		...
		<div className="flex flex-col pl-5 pr-5 h-screen bg-[#000423]">
          ...
          <div className="relative w-32 mb-8 ml-auto mr-auto">
            <div className="rounded-full w-32 h-32 bg-[#40435a] border border-[#707070]" style={renderProfileStyle()}>
              {saving && (
                <svg aria-hidden="true" className="absolute bottom-0 top-0 left-0 right-0 m-auto w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mb-10">
              <Link to="/subscriptions/active-subscriptions" className="font-medium text-sm text-blue-600 dark:text-blue-500 hover:underline pb-10 mb-20">
