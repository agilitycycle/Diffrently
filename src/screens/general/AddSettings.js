...
import Settings from '../../components/Cards/type/Settings';
	...
	return (<>
      ...
      <div className="flex flex-col items-center h-3/5 sm:h-4/5">
        <div className="w-full sm:w-3/4 mx-auto pt-20 mb-14">
          <ol className="flex items-center justify-center w-full text-base font-medium text-gray-500 dark:text-gray-400 sm:text-base">
            ...
            <li className="flex md:w-full items-center text-blue-600 dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700">
              <span className="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
